...
export const ButtonBack = styled.div`
  ...
  color: #fff;
  background: ${(props) => props.alt ? 'linear-gradient(270deg, #ff622e 0%, #B133FF 100%)' : 'linear-gradient(270deg, #00DBD8 0%, #B133FF 100%)'};
  cursor: pointer;
...
export const ButtonFront = styled.button`
  ...
  width: 100%;
  height: 100%;
  background: ${(props) => props.alt ? 'linear-gradient(270deg, #F46737 0%, #945DD6 100%)' : 'linear-gradient(270deg, #13ADC7 0%, #945DD6 100%)'};
